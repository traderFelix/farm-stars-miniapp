...
VIEW_THEFT_ATTACK_DURATION_SECONDS = _get_int_env("VIEW_THEFT_ATTACK_DURATION_SECONDS")
VIEW_THEFT_PROTECTION_ACTIVATION_SECONDS = _get_int_env("VIEW_THEFT_PROTECTION_ACTIVATION_SECONDS")
